...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initModel() {
        ...
        new RGBELoader()
            ...
            // O caminho foi corrigido de './assets/3d/' para '../assets/3d/'
            .setPath('../assets/3d/model2/')
        ...
        // O caminho foi corrigido de './assets/models/smart_water.glb' para '../assets/models/smart_water.glb'
        loader.load(
            '../assets/3d/models2/smart_water.glb',
            (gltf) => {
                model = gltf.scene;
                scene.add(model);
                hideLoading();
